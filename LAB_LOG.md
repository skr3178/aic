...
- **NEXT (biggest levers, from `sfp_free` 92.2):** (1) **SFP partial→FULL seat ≈ +74** — orientation precision (board yaw 1–3° vs GT's exact quat) is what binds the plug; (2) **SC port lock 58 mm off ≈ +40** — SC perception bug (offline was 6/6 ≤1 mm); (3) **t0 −36** — two-segment approach (hold altitude → hover over port → straight down; it currently descends diagonally while translating).
